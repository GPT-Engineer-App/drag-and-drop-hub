...
**Project**: drag-and-drop-hub 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Can you build me a simple Trello clone supporting dragging and dropping cards between columns? use npm packages like panega dnd to achive this functionality 
...
```sh
git clone https://github.com/GPT-Engineer-App/drag-and-drop-hub.git
cd drag-and-drop-hub
npm i
